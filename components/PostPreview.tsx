...
export const PostPreview: React.FC<PostPreviewProps> = ({ 
  ...
  // Colores Oficiales Facebook Dark Mode: #242526 (Card), #B0B3B8 (Secondary Text)
  ...
  return (
    <div className={`${FB_CARD_BG} rounded-lg w-full shadow-sm border ${FB_BORDER} font-sans overflow-hidden`}>
      ...
      <div className="p-3 flex items-start">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className={`flex items-center gap-1 text-[13px] ${FB_TEXT_SEC}`}>
             ...
             <span>·</span>
             <svg viewBox="0 0 16 16" width="12" height="12" fill="currentColor" title="Público">
      ...
      {/* Footer de Acciones (Estilo Exacto Facebook) */}
