...
export const Icon: React.FC<IconProps> = ({ name, className, size = 6 }) => {
  ...
  return <SvgIcon className={`${s} ${className || ''}`} />;
};
...
const icons: { [key: string]: React.FC<React.SVGProps<SVGSVGElement>> } = {
  ...
  history: (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 16v-2m8-8h2M4 12H2m15.364 6.364l1.414 1.414M4.222 4.222l1.414 1.414M19.778 4.222l-1.414 1.414M6.636 19.364l-1.414 1.414M12 18a6 6 0 100-12 6 6 0 000 12z" />
    </svg>
  ),
  check: (props) => (
     <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  list: (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M1 6h.01M1 10h.01M1 14h.01M1 18h.01" />
    </svg>
  ),
  school: (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
